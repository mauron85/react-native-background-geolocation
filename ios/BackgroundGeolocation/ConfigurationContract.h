...
#ifndef ConfigurationContract_h
#define ConfigurationContract_h
...
@interface ConfigurationContract : NSObject

+ (NSString*) createTableSQL;

@end

#endif /* ConfigurationContract_h */
