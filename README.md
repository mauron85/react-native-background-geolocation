...
| `notificationIconLarge`   | `String` optional | Android      | The filename of a custom notification icon. See android quirks. (Images have to reside in res/drawable folder)                                                                                                                                                                                                                                                                                   |
| `notificationIconSmall`   | `String` optional | Android      | The filename of a custom notification icon. See android quirks. (Images have to reside in res/drawable folder)                                                                                                                                                                                                                                                                                   |
